---
{"dg-publish":true,"permalink":"/sobre-o-projeto/","tags":["💼","mdc"],"created":"2024-02-05T11:59:49.732-03:00","updated":"2024-02-05T11:37:51.290-03:00"}
---
...
>> [!warning]+ 📍 Espaço
>> ```meta-bind
INPUT[multiSelect(class(multiselect), option([[Portfólio online/Espaços/Herbário Norte Mineiro\|Herbário Norte Mineiro]], | MCCA |), option([[Portfólio online/Espaços/Centro de Memória da Escola de Enfermagem\|Centro de Memória da Escola de Enfermagem]], | CEMENF |), option([[CEMEMOR]], | CEMEMOR |), option([[Portfólio online/Espaços/Centro de Memória da Odontologia\|Centro de Memória da Odontologia]], | CMO |), option([[Centro de Pesquisa, Memória e Documentação da Faculdade de Educação]], | CEDOC-FaE |), option([[Portfólio online/Espaços/Museu da Matemática\|Museu da Matemática]], | MuMat |), option([[Portfólio online/Espaços/Núcleo Técnico Científico da Rede\|Núcleo Técnico Científico da Rede]], | Rede |), option([[Portfólio online/Espaços/GT Divulgação Científica\|GT Divulgação Científica]], | GEDIC |)):espaco]
>>```
>
...
>>[!keywords]+ 🎯 Meta TCM
>> ```meta-bind
INPUT[multiSelect(class(multiselectpess), option([[Portfólio online/Metas/Meta 3 - Gedic\|Meta 3 - Gedic]], | GEDIC |), option([[Portfólio online/Metas/Meta 1 - Circuito\|Meta 1 - Circuito]], | Circuito - Criação |), option([[Portfólio online/Metas/Meta 2 - Estande\|Meta 2 - Estande]], | Estande - Criação |), option([[Portfólio online/Metas/Meta 4 - Criação e Divulgação Agenda C-C\|Meta 4 - Criação e Divulgação Agenda C-C]], | Agenda - Criação |), option([[Portfólio online/Metas/Meta 5 - Divulgação e lançamento - Circuitos\|Meta 5 - Divulgação e lançamento - Circuitos]], | Circuito - Difusão |), option([[Portfólio online/Metas/Meta 6 - Divulgação e Lançamento - Estande\|Meta 6 - Divulgação e Lançamento - Estande]], | Estande - Difusão |), option([[Portfólio online/Metas/Meta 11 - Divulgação Agenda C-C\|Meta 11 - Divulgação Agenda C-C]], | Agenda - Difusão |), option([[Portfólio online/Metas/Meta 17 - Divulgação semanal Agenda C-C\|Meta 17 - Divulgação semanal Agenda C-C]], | Espaços - Difusão semanal |), option([[Portfólio online/Metas/Meta 10 - Montagem do estande\|Meta 10 - Montagem do estande]], | Estande - AP |), option([[Portfólio online/Metas/Meta 15 - Estande viajante\|Meta 15 - Estande viajante]], | Estande - Escolas |), option([[Portfólio online/Metas/Meta 7 - Visitas Amplo Público\|Meta 7 - Visitas Amplo Público]], | Visitas - AP |), option([[Portfólio online/Metas/Meta 8 - Visitas Educação Básica\|Meta 8 - Visitas Educação Básica]], | Visitas - EB |), option([[Portfólio online/Metas/Meta 9 - Formação para professores\|Meta 9 - Formação para professores]], | Formações |), option([[Portfólio online/Metas/Meta 14 - Oficinas presenciais\|Meta 14 - Oficinas presenciais]], | Oficinas |), option([[Portfólio online/Metas/Meta 16 - Videopitches\|Meta 16 - Videopitches]], | Videopitches |), option([[Portfólio online/Metas/Meta 18 - DC de conhecimentos\|Meta 18 - DC de conhecimentos]], | DC & Ciência Aberta |)):metas]
>>```
>
